...
// Style JSON pour masquer TOUT le fond Google Maps (routes, labels, etc.)
  ...
  return (
    <View style={styles.container}>
      <MapView
        ...
        mapType="standard" // Fix: Force l'initialisation du moteur
        customMapStyle={BLANK_MAP_STYLE} // Fix: Rend le fond invisible
      ...
      >
        <UrlTile
          ...
          shouldReplaceMapContent={true} // Fix: Priorité absolue aux tuiles OSM
        />
