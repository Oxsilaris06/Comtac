...
module.exports = function(config) {
  // On applique nos deux plugins de réparation (MusicControl + KeyEvent)
  return withKeyEventInjection(
    withMusicControlFix({
      name: "COM TAC v14",
      slug: "comtac-v14",
      version: "1.0.0",
...
// --- PLUGIN 1 : Réparation MusicControl (Service Média) ---
...
// --- PLUGIN 2 : Injection KeyEvent (Intercept. Boutons Physiques) ---
...
import android.view.KeyEvent;`
    ...
    // 2. Injecter la méthode dispatchKeyEvent dans la classe MainActivity
    // Cette méthode intercepte TOUS les appuis boutons avant le système
...
`;
        // On insère le code avant la dernière accolade fermante de la classe
